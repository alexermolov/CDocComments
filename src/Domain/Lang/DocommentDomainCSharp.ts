...
export class DocommentDomainCSharp extends DocommentDomain {
    ...
    /* @implements */
    public WriteComment(code: string, codeType: CodeType, docomment: string): void {
    ...
    private IsTriggerDocommentCpp(): boolean {
        ...
        // NG: KeyCode is NOT '/' or Enter
        const isSlashStarKey: boolean = SyntacticAnalysisCSharp.IsSlashStarKey(activeChar);
        const isEnterKey: boolean = SyntacticAnalysisCSharp.IsEnterKey(activeChar, eventText);
    ...
    private GeneSummaryCpp(code: string, paramNameList: Array<string>, hasReturn: boolean): string {
